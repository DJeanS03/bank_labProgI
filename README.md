...
- Criar a estrutura modular baseada em Clean Architecture para o módulo hello-world, com divisão em camadas (interface, use-case, domain, infra) e utilitários em @libs.
- Criar contratos (interfaces e DTOs), stubs e documentação por pasta.
- Nenhuma lógica de negócio real nesta entrega.

#### O que foi feito:

- Estrutura completa criada conforme especificação.
- Cada camada possui seu próprio README.md explicativo.
- Stubs criados para repositórios e controladores.
- Entrega documentada em [DELIVERY.md](src/modules/hello-world/DELIVERY.md).

#### Como foi feito:

- Scaffold automatizado via PowerShell.
- Todos os arquivos criados com foco em separação de responsabilidades.
- Lógica de negócio deixada para etapas futuras.
